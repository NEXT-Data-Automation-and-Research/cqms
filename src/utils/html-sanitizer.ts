  ...
  if (isDOMPurifyAvailable()) {
    try {
      const sanitized = DOMPurify.sanitize(html, {
        ALLOWED_TAGS: ['b', 'i', 'em', 'strong', 'a', 'p', 'br', 'span', 'div', 'nav', 'ul', 'ol', 'li', 'button', 'svg', 'path', 'polyline', 'polygon', 'circle', 'rect', 'g', 'line', 'defs', 'linearGradient', 'stop', 'input', 'label', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'style', 'img', 'select', 'option', 'table', 'thead', 'tbody', 'tr', 'td', 'th', 'form', 'textarea', 'small', 'main', 'section', 'article', 'header', 'footer', 'aside', 'figure', 'figcaption', 'dl', 'dt', 'dd', 'blockquote', 'cite', 'code', 'pre', 'mark', 'del', 'ins', 'sub', 'sup', 'time', 'abbr', 'address', 'hr'],
        ALLOWED_ATTR: ['href', 'class', 'id', 'title', 'target', 'role', 'aria-label', 'aria-hidden', 'aria-expanded', 'aria-current', 'aria-describedby', 'aria-live', 'tabindex', 'viewBox', 'fill', 'stroke', 'stroke-width', 'stroke-linecap', 'stroke-linejoin', 'stroke-dasharray', 'stroke-dashoffset', 'd', 'type', 'checked', 'disabled', 'readonly', 'xmlns', 'style', 'src', 'alt', 'width', 'height', 'referrerPolicy', 'points', 'cx', 'cy', 'r', 'x', 'y', 'rx', 'ry', 'x1', 'y1', 'x2', 'y2', 'offset', 'stop-color', 'stop-opacity', 'selected', 'value', 'name', 'colspan', 'rowspan', 'colSpan', 'rowSpan', 'placeholder', 'for', 'min', 'max', 'step', 'required', 'pattern', 'rows', 'cols', 'autocomplete', 'autofocus', 'multiple', 'size', 'spellcheck', 'wrap', 'accept', 'accept-charset', 'action', 'enctype', 'method', 'novalidate', 'rel', 'download', 'hreflang', 'media', 'ping', 'referrerpolicy', 'shape', 'coords', 'usemap', 'ismap', 'loading', 'decoding', 'crossorigin', 'sizes', 'srcset', 'datetime', 'pubdate', 'cite', 'open', 'reversed', 'start'],
