...
export const routes: RouteConfig[] = [
  ...
  {
    path: '/src/features/massive-ai-audit/presentation/massive-ai-audit-result.html',
    slug: 'massive-ai-audit-result',
    meta: {
      label: 'Massive AI Audit',
      icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>',
      roles: ['Quality Analyst', 'Admin', 'Super Admin'],
      sidebar: true,
      badge: 'Beta',
      order: 5.2
    }
  ...
  {
    path: '/src/features/massive-ai-audit/presentation/my-audit-results.html',
    slug: 'my-ai-audit-results',
    meta: {
      label: 'My AI Audits',
  ...
  {
    path: '/src/features/performance-analytics/presentation/performance-analytics.html',
    slug: 'performance',
    meta: {
      label: 'Performance',
      icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>',
      roles: ['Quality Analyst', 'Quality Supervisor', 'Supervisor', 'Admin', 'Manager', 'Super Admin'],
      sidebar: true,
      order: 6,
  ...
  },
  {
    ...
    meta: {
      ...
      roles: ['all'],
      sidebar: true,
      sidebarLink: '/settings/scorecards',
      order: 11
    },
    submenu: [
      {
      ...
      {
        path: '/src/features/settings/supervisor-assignments/presentation/supervisor-assignments.html',
        label: 'Supervisor Assignments',
        roles: ['Admin', 'Super Admin'],
        slug: 'supervisor-assignments',
        permissionResource: { name: 'settings/supervisor-assignments', type: 'page' }
      },
      {
