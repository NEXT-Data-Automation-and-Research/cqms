...
export const routes: RouteConfig[] = [
  ...
  {
    path: '/improvement-corner',
    meta: {
      label: 'Improvement Corner',
    ...
    submenu: [
      {
        path: '/src/features/improvement-corner/calibration/presentation/calibration.html',
        label: 'Calibration',
        roles: ['all']
      },
      {
        path: '/src/features/improvement-corner/ata/presentation/ata.html',
        label: 'ATA',
        roles: ['all']
      },
      {
        path: '/src/features/improvement-corner/grading-guide/presentation/grading-guide.html',
        label: 'Grading Guide',
        roles: ['all']
      }
    ]
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        path: '/src/features/help/bug-report/presentation/bug-report.html',
        label: 'Report a Bug',
        roles: ['all']
      },
      {
        path: '/src/features/help/bug-reports-view/presentation/bug-reports-view.html',
  ...
  },
  {
    ...
    submenu: [
      {
        path: '/src/features/audit-form/audit-form.html',
        label: 'Audit Form',
        roles: ['all']
      }
    ]
