...
export const PAGE_RESOURCES = {
  ...
  SETTINGS_SUPERVISOR_ASSIGNMENTS: 'settings/supervisor-assignments',
...
export const ALL_RESOURCES_FOR_UI: Array<{ value: string; label: string; type: PermissionRuleType }> = [
  ...
  { value: PAGE_RESOURCES.SETTINGS_SUPERVISOR_ASSIGNMENTS, label: 'Supervisor Assignments', type: 'page' },
...
export function getPageResourceBySlug(slug: string): string | null {
  const map: Record<string, string> = {
    ...
    'supervisor-assignments': PAGE_RESOURCES.SETTINGS_SUPERVISOR_ASSIGNMENTS,
